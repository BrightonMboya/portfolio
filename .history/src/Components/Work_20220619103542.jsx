        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                ...
                <a href="https://github.com/BrightonMboya/Skope" target='_blank'>
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
                  </button>
                </a>
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://625d25be854d190d429096ec--merry-crepe-a1321f.netlify.app/" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
                  </button>
                </a>
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-lg font-bold text-gray-100 tracking-wider">
                A Reddit Clone that allows users support CRUD on posts, comments and vots. Build with MERN
              </span>
              <div className="pt-8 text-center">
                ...
                <a href="https://www.figma.com/file/Oxeoui287KWCbcYWXQspCr/Pet-Store-Landing-Page?node-id=0%3A1" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
                  </button>
                </a>
          ...
          {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${portfolio})`, objectPosition: 'cover' }}
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-lg font-bold text-white tracking-wider">
                A portfolio Template for software engineers. Made with HTML, TailWindCSS, and JS.
              </span>
              <div className="pt-8 text-center">
